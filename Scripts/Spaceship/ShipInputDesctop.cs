...
{
	public class ShipInputDesctop : MonoBehaviour, IInputShipMovement, IInputShipWeapons
    {
		[field: Header("Spaceship Movement Values")]
        ...
        [field: Header("Spaceship Attack Values")]
